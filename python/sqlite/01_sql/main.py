...
## cre4ar un archivop diferente 
config.name_file_excel = "data"
...
study= [
    ('nico',25,"nico@gmail.com"),
    ('patio',30,"pati@gmail.com"),
    ('rebe',35,"reb@gmail.com"),
    ('lucas',40,"luki@gmail.com"),
 ]


# llamar al paquete core y importar manajer,llamar a la funcion create_excel()y pasarle los parametros requeridos
# manajer.create_excel(rows,["id","name"])
manajer.create_excel(study,["name","age","email"])
